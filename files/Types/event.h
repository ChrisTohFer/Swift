...
//When copied, copy listeners
template<typename ...PARAMS>
inline SWIFT::EVENT<PARAMS...>::EVENT(const EVENT& other)
{
...
template<typename ...PARAMS>
inline SWIFT::EVENT<PARAMS...>::EVENT(EVENT&& other) noexcept
{
	auto begin = other.m_listeners.begin();
	auto end = other.m_listeners.end();
...
template<typename ...PARAMS>
inline SWIFT::EVENT<PARAMS...>::~EVENT()
{
	remove_all_listeners();
}

template<typename ...PARAMS>
inline void SWIFT::EVENT<PARAMS...>::add_listener(LISTENER* listener)
{
...
template<typename ...PARAMS>
inline void SWIFT::EVENT<PARAMS...>::remove_listener(LISTENER* listener)
{
...
template<typename ...PARAMS>
inline void SWIFT::EVENT<PARAMS...>::remove_all_listeners()
{
...
template<typename ... PARAMS>
inline void SWIFT::EVENT<PARAMS...>::invoke(PARAMS... params) const
{
	auto begin = m_listeners.begin();
	auto end = m_listeners.end();
...
template<typename ...PARAMS>
inline SWIFT::EVENT<PARAMS...>::LISTENER::LISTENER(const LISTENER& other)
{
...
template<typename ...PARAMS>
inline SWIFT::EVENT<PARAMS...>::LISTENER::LISTENER(LISTENER&& other) noexcept
{
	auto begin = other.m_listenees.begin();
	auto end = other.m_listenees.end();
...
template<typename ...PARAMS>
inline SWIFT::EVENT<PARAMS...>::LISTENER::~LISTENER()
{
	stop_listening();
}

template<typename ...PARAMS>
inline void SWIFT::EVENT<PARAMS...>::LISTENER::listen(EVENT* evt)
{
...
template<typename ...PARAMS>
inline void SWIFT::EVENT<PARAMS...>::LISTENER::stop_listening(EVENT* evt)
{
...
template<typename ...PARAMS>
inline void SWIFT::EVENT<PARAMS...>::LISTENER::stop_listening()
{
